...
const CompanyPage = async ({ params }) => {
    ...
    const jsonLd = {
        ...
        "url": `https://www.globalbizreport.com/${encodeURIComponent(companyName)}/${cin}/${country}/${stateCode}/company-business-financial-credit-report`
    };

    // FIXED: Corrected string template interpolation syntax for Google Maps
    ...
    function parseCin(targetCin) {
        ...
        return `Registration Analysis: Based on its corporate identifier ${targetCin}, this entity is classified as an ${isListed} ${type} established in the year ${year}.`;
    }
            ...
            <div className="max-w-6xl mx-auto flex flex-col pb-24 rounded-lg min-h-svh">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-4 gap-x-6 gap-y-5">
                    <div className="md:col-span-3">
                        <div className="bg-white rounded-lg p-4 sm:p-6 lg:p-8">
                            <div className="mb-4">
                                <h1 className="text-sm font-bold text-gray-500">{companyName}</h1>
                            </div>
                                ...
                                <div className="group relative p-2 rounded-2xl border border-slate-100 bg-white hover:bg-slate-50 hover:border-blue-200 transition-all duration-300 cursor-pointer mb-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-grow">
                                            <h3 className="text-md font-bold text-slate-900 group-hover:text-blue-600 transition-colors">Claim This Profile</h3>
                                            <p className="text-xs text-slate-500 mt-0.5">Verify ownership and manage details.</p>
                                        </div>
                            ...
                            <h2 className="text-lg font-semibold text-gray-600 mb-4 sm:mb-6 pb-2">Company Details</h2>
                            ...
                            <div className="relative w-full p-4 md:p-8 mt-5 bg-gray-50 flex flex-col justify-between overflow-hidden group">
                                <div className="relative z-10 space-y-5">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-sm text-slate-800 font-medium leading-relaxed">{companyData?.registered_office_address || "N/A"}</p>
                                    </div>
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                                        <div className="flex flex-row items-center justify-between p-5 border border-slate-100 rounded-sm bg-white hover:border-blue-100 transition-all">
                                            <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex items-start space-x-3 p-3 bg-slate-50 rounded-lg border border-slate-100">
                                                ...
                                                <p className="text-sm leading-relaxed text-gray-700">{parseCin(cinNumber)}</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div className="bg-white p-6 text-gray-800 space-y-4">
                            ...
                            <p className="leading-relaxed">
                                <span className="font-medium">{companyName}</span>, incorporated on{" "}
                                <span className="font-medium">{incorporationDate}</span>, is a <span className="font-medium">{companyData?.companycategory || "N/A"}</span> operating under the{" "}
                                <span className="font-medium">{companyData?.companysubcategory || "N/A"}</span> category. Legally registered as a{" "}
                                <span className="font-medium">{companyData?.companyclass || "N/A"}</span>, the company falls under the jurisdiction of the Registrar of Companies, <span className="font-medium">{companyData?.companyroccode || "N/A"}</span>. The official Corporate Identification Number (CIN) is <span className="font-medium">{cinNumber}</span>, and its current status is recorded as <span className="font-medium">{companyData?.companystatus || "N/A"}</span>.
                            </p>
                            <p className="leading-relaxed break-words">
                                The company is engaged in <span className="font-medium">{companyData?.companyindustrialclassification || "N/A"}</span>, with its primary operations identified under NIC code <span className="font-medium">{companyData?.nic_code || "N/A"}</span>. Its registered office is situated at <span className="font-medium break-words">{companyData?.registered_office_address || "N/A"}</span>, located in <span className="font-medium">{stateCode}</span>. Structurally, the company is recognized as <span className="font-medium">{companyData && companyData['CompanyIndian/Foreign Company'] || 'Indian'}</span>, with financial backing that includes an authorized capital of <span className="font-medium">₹{companyData?.authorizedcapital || "0"}</span> and a paid-up capital of <span className="font-medium">₹{companyData?.paidupcapital || "0"}</span>.
                            </p>
                        ...
                        <div className="flex flex-col items-left text-left p-5">
                            ...
                            <p className="text-base text-gray-800 mb-4">
                                You may want to get a clear understanding of your company’s financial strength, trust score, and potential risks with a detailed credit report. It shows how buyers, investors, and partners perceive your business...
                            </p>
                    ...
                    <div className="md:col-span-1 flex flex-col items-center justify-start gap-6 p-2">
                        <div className="relative w-full rounded-2xl p-6 bg-purple-100/50 border border-[#f3e8ff] shadow-xl flex flex-col justify-between overflow-hidden group">
                            <div>
                                <h2 className="text-2xl font-bold text-[#4c1d95] leading-tight">Is this <br /><span className="text-slate-900 font-serif">your company?</span></h2>
                                <p className="text-slate-500 text-xs py-4 max-w-[260px] font-medium leading-relaxed">Customize this page with updated profile/product catalog/contact information for better reach.</p>
                                <div className="flex flex-row items-center justify-start text-blue-600 text-xs leading-relaxed mb-4 max-w-[240px] font-medium">
                                    <a href="/sample-claimed-company" target="_blank" className="mr-1 text-blue-600 underline">Sample claim company page</a>
                            ...
                            <ClaimRedirect company={companyData}>
                                <div className="cursor-pointer group/btn relative w-fit flex items-center gap-3 overflow-hidden rounded-lg bg-gradient-to-br from-[#581c87] to-[#2e1065] px-7 py-3.5 text-[11px] font-bold uppercase tracking-widest text-white shadow-lg transition-all active:scale-95">
                                    <span>Claim Now</span>
                        ...
                        <div className="relative w-full rounded-xl p-6 bg-[#0a0a0a] border-t-2 border-amber-500 shadow-2xl flex flex-col justify-between overflow-hidden group">
                            <div>
                                <h2 className="text-2xl font-bold text-amber-600 leading-tight tracking-tight">Self Company<br /><span className="text-orange-200"> Report</span></h2>
                                <p className="text-slate-400 text-xs leading-relaxed py-4 max-w-[240px] font-medium">Buy a Credit Report of your own company to boost credibility and trustworthiness.</p>
                            </div>
                            <div className="p-1 bg-warning shadow-2xl rounded-md px-5 w-fit text-black font-semibold">
                        ...
                        <div className="relative w-full rounded-xl p-6 bg-[#0f1110] border-t-2 border-emerald-500 shadow-2xl flex flex-col justify-between overflow-hidden group">
                            <div>
                                <h2 className="text-2xl font-bold text-emerald-500 leading-tight tracking-tight">Business<br /><span className="text-slate-100">Credit Report</span></h2>
                                <p className="text-slate-400 text-xs leading-relaxed py-4 max-w-[240px] font-medium">Order a Comprehensive Business Information Report for detailed company insights.</p>
                            </div>
                            <ClientPurchaseButton companyData={companyData} label="Request Full Report" bgColor="emerald" />
                        </div>
                    </div>
                </div>
                ...
                <div className="fixed bottom-0 left-0 w-full bg-gray-600 text-white p-4 flex justify-between xl:justify-end items-center shadow-lg z-50">
                    <div className="rounded-md px-2 text-base font-medium flex items-center gap-2">
                        <FaFile className="h-5 w-5" />
                        <ClientPurchaseButton companyData={companyData} label="Order Business Credit Report For This Company." bgColor="gray" />
                    </div>
                </div>
                ...
                <div className="w-full px-4 py-8 bg-white space-y-6">
                    <div className="flex items-start gap-3">
                        ...
                        <p className="text-gray-700 leading-relaxed text-base">Check basic information about a company and order a Freshly Investigated Company Credit Report...</p>
                    </div>
                </div>
            </div>
        </>
