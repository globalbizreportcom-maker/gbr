...
export default function Page() {
    ...
    const reviews = [
        {
            name: "GlobalTech Ltd",
            review: "Excellent team and very professional work delivery."
        },
        {
            name: "StartupHub",
            review: "They helped us launch our brand successfully."
        }
    ]

    return (

        <div className="max-w-6xl mx-auto px-2 flex flex-col py-12 md:py-24  rounded-lg min-h-svh">
            ...
            <div className="relative h-[280px] w-full">
                ...
                {/* Company Info */}
                <div className="absolute bottom-[-30px] md:bottom-[-40px] left-10 flex items-center gap-5">
                    ...
                    <div className="text-white">
                        <h1 className="text-xl md:text-3xl font-semibold">{company.name}</h1>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-x-6 gap-y-5">
                ...
                ${activeTab === tab
                            ...
                            {activeTab === "about" && (
                                ...
                                <div className="py-8 md:py-10 max-w-5xl space-y-8 md:space-y-10">
                                    {/* Intro */}
                                    <div>
                            ...
                            {activeTab === "services" && (
                                ...
                                <div className="py-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    {services.map((service, i) => (
                                        ...
                                        <div key={i} className="border rounded-lg bg-white p-5">
                            ...
                            {activeTab === "contact" && (
                                ...
                                <div className="py-8 ">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-sm text-gray-600">
                                        ...
                                        <div className="rounded-lg p-4 bg-white md:col-span-2">
                ...
                <div className="md:col-span-1 flex flex-col items-center justify-start gap-6 px-2 py-10">
                    ...
                    {/* Content */}
                    <div className="relative z-10 text-left p-5 flex flex-col items-start bg-gray-100 rounded-2xl" >
                    ...
                    <div className="relative z-10 text-left p-5 flex flex-col items-start bg-gray-100 rounded-2xl" >
                        ...
                        <button className="btn btn-md btn-warning border-none rounded-md px-5 w-full">
                ...
                {/* <div className="fixed bottom-0 left-0 w-full bg-gray-600 text-white p-4 flex justify-between xl:justify-end  items-center shadow-lg z-50">
                    ...
                    >
                        <FaFile className="h-5 w-5" />
                        <ClientPurchaseButton label='Order a Comprehensive Business Information Report for this Company.' bgColor='orange' />
                    </div>
